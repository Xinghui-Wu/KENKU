...
def black_box_asr(input_csv, output_csv, language, vendor):
    ...
    with open(output_csv, 'w') as csv_file:
        ...
        for audio_info in audio_table[1: ]:
            ...
            try:
                if vendor == 0:
                    asr_results = [google_asr(audio_path, language), microsoft_asr(audio_path, language)]
                else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Black-box commercial ASR cloud service interfaces.")
    parser.add_argument("-i", "--input_csv", type=str, default="input.csv", help="Path of the information CSV file generated by the KENKU attacks.")
    parser.add_argument("-o", "--output_csv", type=str, default="output.csv", help="Path of the output CSV file that contains the transcribed results of the target ASR systems.")
    parser.add_argument("-l", "--language", type=int, default=0, help="Specify 0 or 1 to transcribe English or Chinese contents respectively.")
    parser.add_argument("-v", "--vendor", type=int, default=1, help="Specify 0 to invoke the Google/Microsoft APIs and specify 1 to invoke the Alibaba/Tencent/iFLYTEK APIs.")
